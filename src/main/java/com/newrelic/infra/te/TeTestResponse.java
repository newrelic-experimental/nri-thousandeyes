...
public class TeTestResponse {
	@JsonProperty(value="test")
	private TeTest[] teTests = null;

	public TeTest[] getTeTests() {
		return teTests;
	}

	public void setTeTests(TeTest[] teTests) {
		this.teTests = teTests;
	}

	@Override
	public String toString() {
		return "TeTestResponse [teTests=" + Arrays.toString(teTests) + "]";
	}
